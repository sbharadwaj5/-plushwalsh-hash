...
record_count = 1000
keys = [random.randint(1, 500) for _ in range(record_count)]
output = []
...
print("ycsb_load.txt generated with 1000 integer-key operations (no field0).")
